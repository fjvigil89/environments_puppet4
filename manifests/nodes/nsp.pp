node 'ns1p.upr.edu.cu' {
  ...
  class { '::dns_primary':
    ...
    zone_type          => $zone,
    file_zone_name     => [ 'db.upr.edu.cu', 'db.1.2.10', 'db.3.2.10','db.4.2.10' ,'db.8.2.10','db.upr.edu.cu.external', 'db.49.14.200.in-addr.arpa.zone'],
    zone_reverse       => [ '1.2.10.in-addr.arpa', '2.2.10.in-addr.arpa', '3.2.10.in-addr.arpa', '4.2.10.in-addr.arpa', 'db.49.14.200.in-addr.arpa.zone'],
    views              => {
      'internal' => {
        ...
        'external'         => {
          ...
          'zones'         => {
            ...
            'db.143.55.200.in-addr.arpa' => [
              $zone,
              "allow-query { any; }",
              "allow-update ${notify_external}",
              "also-notify ${notify_external}",
              "notify yes",
              "file ${quote}${direct}/db.143.55.200.in-addr.arpa${quote}",
            ],
          },
        },
    },

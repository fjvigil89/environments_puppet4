...
samba::server::share { 'fcf':
  ...
  exec { "add smb account for fcf":
    ...
    class{'::wh_php_apache':
    version => "7.4",
    packages => ["php7.4","php7.4-mbstring","php7.4-cli","php7.4-curl","php7.4-intl","php7.4-ldap","php7.4-mysql","php7.4-sybase","libapache2-mod-php7.4","php7.4-zip","phpmyadmin"],
  }
  apache::vhost { $fqdn:
    port       => '80',
    docroot    => '/srv/ftp',

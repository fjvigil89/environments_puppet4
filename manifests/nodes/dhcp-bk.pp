node 'dhcp-bk.upr.edu.cu' { 
  ...
  class {'dhcpserver':
      interfaces   => ['eth0'],
      pool_enabled => true,
      pool         => ['Assets','Trabajadores','Estudiantes'],
      network      => ['10.2.132.0','10.2.133.0','10.2.134.0'],
      mask         => ['255.255.255.0','255.255.255.0','255.255.255.0'],
      range        => ['10.2.132.10 10.2.132.254','10.2.133.2 10.2.133.254','10.2.134.2 10.2.134.254'],
      gateway      => ['10.2.132.1','10.2.133.1','10.2.134.1'],
      host_enabled => false,

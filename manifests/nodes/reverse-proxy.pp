...
node /^reverse-proxy\d+$/{
  ...
  class { 'reverse_proxy_server':
    ...
    listen_port    => [80,80,80,80,443,80,80,443,80,80,80,80,80,80,80,80,80,80,80,80,80,80,80,80,80,80,80,80,80],
    ssl_port       => [80,443,443,443,443,443,443,443,80,80,80,80,80,80,80,80,80,80,80,80,80,80,80,80,80,80,80,80,80],
    location_allow => [
      '*',
      '*',
      '*',

...
node 'dns-cache0.upr.edu.cu'{
  class {'::dns_secundary':
    ...
    allow_query        => ['10.2.1.0/24', '10.2.22.0/22', '10.2.24.0/22', '10.2.9.0/24', '10.2.68.128/25', '10.2.30.0/24','10.2.128.0/24','200.14.49.0/27', '200.55.143.8/29', '152.207.173.40/29'],
  }

...
node 'smokeping.upr.edu.cu'{
  ...
  class {'smokeserver':
    target           => ['Routers','L3','PAP','FCP','FCF','Docente','CUM','Vinales','Palacios','San_Luis','Minas','Guane','Mantua','La_Palma','Sandino','Consolacion','UD','Camilo Cienfuegos','Macurije','Guanahacabibes','Soroa'],

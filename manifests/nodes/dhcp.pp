node 'dhcp.upr.edu.cu' { 
  ...
  class {'dhcpserver':
      ...
      network      => ['10.2.4.0','10.2.70.0', '10.2.64.0', '10.2.80.0', '10.2.81.128','10.2.83.0'],
      mask         => ['255.255.254.0','255.255.254.0','255.255.255.0','255.255.255.0','255.255.255.128','255.255.255.0'],
      ...
      gateway      => ['10.2.5.254','10.2.70.1', '10.2.64.1', '10.2.80.1', '10.2.81.129', '10.2.83.1'],
    }
